...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <div class="col-lg-3">
                <a href="{{ route('artikel.create') }}" class="btn btn-outline-success px-4 raised d-flex gap-2 text-dark">
                    ...
                    @foreach ($artikel as $item)
                        <tr>
                            ...
                            <form id="destroy-form" action="{{ route('artikel.destroy', $item->id) }}" method="POST"
                                ...
                                <td>
                                    <a href="{{ route('artikel.show', $item->id) }}" class="btn btn-outline-info gap-2 text-dark"><i
                                            class="material-icons-outlined">search</i></a>

                                    <a href="{{ route('artikel.edit', $item->id) }}" class="btn btn-outline-warning gap-2 text-dark"><i
